...
[![Skills](https://img.shields.io/badge/skills-140-blue.svg)](#catalog)
[![Format](https://img.shields.io/badge/format-Hermes%20Agent-8A2BE2.svg)](https://github.com/NousResearch/hermes-agent)

A catalog of 140 platform engineering skills for AI coding agents, covering
...
<details>
<summary><strong>linux</strong> (3) — Command line, filesystem, processes, systemd, and performance.</summary>
