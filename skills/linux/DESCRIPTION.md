...
- **linux-performance-analysis** — Diagnose CPU, memory, disk and network bottlenecks. _(references/)_
- **linux-process-management** — Inspect processes, signals, limits and cgroups. _(references/, scripts/, examples/)_
- **systemd-services** — Write, debug and manage systemd units and timers. _(references/, scripts/, examples/)_
- **ubuntu-administration** — Manage packages, users, network and updates on Ubuntu. _(references/, scripts/)_
